...
public class AdapterSearchedPatients extends ArrayAdapter<ListSearchedPatients> {
    Context context;
    ...
    public AdapterSearchedPatients(Context context, int resource, ArrayList<ListSearchedPatients> objects) {
