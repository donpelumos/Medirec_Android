...
public class AdapterMedicalCondition extends ArrayAdapter<ListAllergy> {
    Context context;
    ArrayList<ListAllergy> allergies;
    int layoutResourceId;
    Typeface robotoThin, robotoLight, robotoRegular, gothic, avenirNextRegular;
    public AdapterMedicalCondition(Context context, int resource, ArrayList<ListAllergy> objects) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        deleteAllergy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Remove Medical COndition");
                builder.setMessage("Are you sure you want to remove this medical condition?");
