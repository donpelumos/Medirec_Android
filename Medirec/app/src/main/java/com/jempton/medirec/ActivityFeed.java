...
/**
 * Created by BALE on 01/12/2016.
 */

public class ActivityFeed extends AppCompatActivity implements TabLayout.OnTabSelectedListener{
    TabLayout tabLayout;
    ViewPager viewPager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        messageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ActivityFeed.this, ActivityMessages.class);
